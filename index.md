...
Hello there, my name is Paul Anzel! I'm a Data Engineer/Data Scientist with experience across the entire data pipeline. I was most recently a Data Engineer with [Rev](https://www.rev.com/) where I focused on maintaining and improving our ETL pipeline, ensuring our business stakeholders got the data they neededm and doing ad-hoc analysis work. Prior to that I've been employed with [Codecov](https://about.codecov.io/) (acquired by Sentry, similar work), [H-E-B](https://www.heb.com/) (data workflow productionalization and data quality management), [Metromile](https://www.metromile.com/) (managing our ETL system and using telematics data to detect vehicle crashes and evaluate potential insurance fraud), and [Wiser](https://www.wiser.com/) (price-demand estimation).
