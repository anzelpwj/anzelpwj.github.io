...
Hello there, my name is Paul Anzel! I'm a Data Engineer/Data Scientist with experience across the entire data pipeline. I am currently a Data Engineer with [Rev](https://www.rev.com/) where I focus on maintaining our ETL pipeline and doing ad-hoc analysis work. Prior to that I've been employed with [Codecov](https://about.codecov.io/) (acquired by Sentry, similar work), [H-E-B](https://www.heb.com/) (data workflow productionalization and data quality management), at [Metromile](https://www.metromile.com/) (managing our ETL system and using telematics data to detect vehicle crashes and evaluate potential insurance fraud), and at [Wiser](https://www.wiser.com/) (price-demand estimation).
